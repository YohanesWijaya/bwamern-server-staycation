...
seeder.connect('mongodb+srv://YohanesWijaya:bwamern@cluster0.4skl1.mongodb.net/db_staycation?retryWrites=true&w=majority', {
  ...
  // start item
  {
    ...
    'documents': [
      ...
      // Spring Lake
      {
        ...
        activityId: [
          { _id: mongoose.Types.ObjectId('5e96cbe292b97300fc90bc01') },
          { _id: mongoose.Types.ObjectId('5e96cbe292b97300fc90bc02') },
          { _id: mongoose.Types.ObjectId('5e96cbe292b97300fc90bc03') },
          { _id: mongoose.Types.ObjectId('5e96cbe292b97300fc90bc04') }
        ],
    ...
    'documents': [
      {
        ...
        bookingStartDate: '28-12-2021',
        bookingEndDate: '31-12-2021',
        invoice: 1231231,
        itemId: {
          _id: mongoose.Types.ObjectId('5e96cbe292b97300fc902222'),
          title: 'Golden Stone',
    ...
    'documents': [
      {
        ...
        firstName: 'Golden',
        lastName: 'Stefanus',
        email: 'golden.422020002@civitas.ukrida.ac.id',
      ...
      },
      {
        ...
        firstName: 'Eluzai',
        lastName: 'Vito',
        email: 'eluzai.422020010@civitas.ukrida.ac.id',
        phoneNumber: '082377954008'
      }
    ]
  },
